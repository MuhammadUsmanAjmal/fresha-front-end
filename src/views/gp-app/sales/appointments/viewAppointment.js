...
const ViewAppointment = (props) => {
  ...
  const CreatedBy = orderDetail?.createdBy;
  const InvoiceTo = orderDetail?.client;
  ...
  // console.log("OrderArray Detail", OrdersArray);
  // console.log("Backnd Data", OrdersData);
        ...
        <>
          ...
          <Col lg="5">
            <h4
              ...
              className="mb-25"
            >
              {DateAppointView(OrderDate[0]?.Date)}
            </h4>
          </Col>
          <CardBody
