...
const UsersList = () => {
  ...
  const CatProdInformation = useSelector((state) => state.getProduct);
  const { loading } = CatProdInformation;
  const ProductCategory = CatProdInformation?.product?.data;
  // ** States
  ...
  const columns = [
    ...
    },
    {
      ...
      selector: "amount",
      sortable: true,
      cell: (row) => row?.amount + " " + row?.measure,
    },
    {
      name: "Price",
      minWidth: "100px",
      selector: "price",
      sortable: true,
      cell: (row) => row?.price + " PKR",
    },
    {
      name: "SKU",
      minWidth: "100px",
      selector: "stockKeepingUnit",
      sortable: true,
      cell: (row) => row?.stockKeepingUnit,
    },
    {
      name: "R-SKU",
      minWidth: "100px",
